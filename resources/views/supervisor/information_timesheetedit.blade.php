                        ...
                        <form name="editInformation" id="editInformation" action="" method="post">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <input class="c-input" type="hidden" name="worker_id" id="worker_id" value="{{ $user_id }}" /> 
                                    ...
                                    <div class="c-field u-mb-small">
                                        ...
                                        <input id="start_time" name="start_time" class="c-input" type="text" value="{{ $objinformationreason[0]['start_time'] }}"/>
                                    </div>
                                    <div class="c-field u-mb-small">
                                        <label class="c-field__label" for="adresses">{{ trans('words.end-time') }}</label>   
                                        <input id="end_time" name="end_time" class="c-input" type="text" value="{{ $objinformationreason[0]['end_time'] }}"/>
                                    </div>
                                    <div class="c-field u-mb-small">
                                        <label class="c-field__label" for="adresses">{{ trans('words.pause-time') }}</label>   
                                        <input id="pausetime" name="pause_time" class="c-input" type="text" value="{{ $objinformationreason[0]['pause_time'] }}"/>
                                    </div>
